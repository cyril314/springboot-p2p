...
public class PatternAndView extends ModelAndView {
    ...
    public PatternAndView(String viewName, HttpServletRequest request, HttpServletResponse response) {
        ...
        String port = ":" + ConverterUtils.toInt(request.getServerPort());
    ...
    protected String getURL(HttpServletRequest request) {
        ...
        if (ConverterUtils.toInt(request.getServerPort()) != 80)
            url = url + ":" + ConverterUtils.toInt(request.getServerPort()) + contextPath;
        else {
            url = url + contextPath;
        }
