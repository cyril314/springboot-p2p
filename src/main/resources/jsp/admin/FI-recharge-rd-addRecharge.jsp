						...
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
							<tr>
								<td style="width: 120px; height: 35px;" align="right" class="blue12">
									用户名：
									<s:textfield id="adminId" name="paramMap.adminId" cssClass="in_text_2" cssStyle="width: 150px;height:20px;display:none" theme="simple" ></s:textfield>
								</td>
								<td align="left" class="f66">
									<s:textfield id="tb_userName" name="paramMap.userName" cssClass="in_text_2" cssStyle="width: 150px;height:20px;line-height: 20px;" theme="simple" readonly="true" ></s:textfield>
									<s:textfield id="tb_userId" name="paramMap.userId" cssClass="in_text_2" cssStyle="width: 150px;height:20px;display:none" theme="simple" readonly="true" ></s:textfield>
								</td>
							</tr>
							...
							<tr>
								...
								<td align="left" class="f66">
									<s:textfield id="tb_money" name="paramMap.dealMoney" cssClass="in_text_2" cssStyle="width: 150px;height:20px;line-height: 20px;" theme="simple" ></s:textfield>
									<span id="money_tip" class="require-field">*<s:fielderror fieldName="paramMap['dealMoney']"></s:fielderror></span>
								</td>
							</tr>
							<tr>
								<td style="width: 120px; height: 35px;" align="right" class="blue12">充值类型：</td>
								<td align="left" class="f66">
								<input type="radio" name="paramMap.recharType" value="5" style="vertical-align:text-bottom; margin-bottom:-2px;" checked="checked"/>充值&nbsp;&nbsp;
								<input type="radio" name="paramMap.recharType" value="8" style="vertical-align:text-bottom; margin-bottom:-2px;"/>理财专用金充值&nbsp;&nbsp;
								<span id="money_tip" class="require-field">*<s:fielderror fieldName="paramMap['recharType']"></s:fielderror></span>
							</tr>
							<tr>
								<td  style="width: 120px; height: 35px;" align="right" class="blue12">充值备注：</td>
								<td>&nbsp;</td>
							</tr>
							<tr>
							...
							<tr>
								<td colspan="2">
									...
									&nbsp;
									<button id="btn_cancel" onclick="cancel();"	style="background-image: url('static/images/admin/btn_reback.jpg'); width: 70px; border: 0; height: 26px"></button>
									&nbsp;
								</td>
							</tr>
						</table>
