					...
					<div
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
							...
							<tr>
								...
								<td align="left" class="f66">
								<input type="radio" name="paramMap.recharType" value="502" style="vertical-align:text-bottom; margin-bottom:-2px;" checked="checked"/>扣费&nbsp;&nbsp;
								<input type="radio" name="paramMap.recharType" value="523" style="vertical-align:text-bottom; margin-bottom:-2px;"/>理财专用金扣费&nbsp;&nbsp;
