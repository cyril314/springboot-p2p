		...
		<script type="text/javascript">
			$(function(){
				...
				$("#excelout").attr("disabled",true);
                     window.location.href=encodeURI(encodeURI("exportUserFundRecharge.do?userId="+$("#userId").val()+"&&rechargeTime="+$("#startTime").val()+"&&statss="+$("#status").val()+"&&reType="+$("#rechargeType").val()+"&&endTime="+$("#endTime").val()));
