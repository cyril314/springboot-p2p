							...
							<tr>
								...
								<td align="left" class="f66">
								 是：<input type="radio" name="paramMap_kaiqi1" value="1"
								 	<c:if test='#request.Messagemap.enable == 1'>checked="checked"</c:if>
											<s:else></s:else>
								 />&nbsp;&nbsp;&nbsp;&nbsp;
								 否：<input type="radio" name="paramMap_kaiqi1" value="0"
								 	<c:if test='#request.Messagemap.enable == 0'>checked="checked"</c:if>
											<s:else></s:else>
								 />
							...
							<tr>
								...
								<td>
									...
									<button id="btn_tijiao1"
										style="background-image: url('static/images/admin/btn_queding.jpg'); width: 70px; height: 26px; border: 0px"></button>
									&nbsp; &nbsp;
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td align="left" class="f66">
								 是：<input type="radio" name="paramMap_kaiqi2" value="1"
								 		 	<c:if test='#request.Messagemap2.enable == 1'>checked="checked"</c:if>
											<s:else></s:else>
								 
								 />&nbsp;&nbsp;&nbsp;&nbsp;
								 否：<input type="radio" name="paramMap_kaiqi2" value="0"
								 	 	<c:if test='#request.Messagemap2.enable == 0'>checked="checked"</c:if>
											<s:else></s:else>
								 />
									<span class="require-field">*</span>
								</td>
