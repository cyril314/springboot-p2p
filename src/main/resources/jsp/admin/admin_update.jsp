...
<html>
	<head>
		...
		<script type="text/javascript" src="${ctx}/static/script/jquery-1.4.2.min.js"></script>
					...
					<div style="width: auto; background-color: #FFF; padding: 10px;">
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
							<tr>
								...
								<c:if test="#request.paramMap.roleId==1" >
									<s:select list="roleList.{?#this.id==1}" name="paramMap.roleId" listKey="id" listValue="name" ></s:select>
								</c:if>
								<s:elseif test="#request.paramMap.roleId==2" >
									<s:select list="roleList.{?#this.id==2}" name="paramMap.roleId" listKey="id" listValue="name" ></s:select>
								</s:elseif>
								<s:else>
									<s:select list="roleList.{?#this.id!=-1&&#this.id!=1&&#this.id!=2}" name="paramMap.roleId" listKey="id" listValue="name" headerKey="-2" headerValue="--请选择--"></s:select>
								</s:else>
