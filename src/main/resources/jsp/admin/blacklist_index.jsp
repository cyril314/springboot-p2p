	...
	<div style="padding: 15px 10px 0px 10px;">
		<div>
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td id="admins" width="100"  class="xxk_all_a"><a href="queryMailBoxListInit.do">管理员与用户</a></td>
					<td width="1">&nbsp;</td>
					<td id="adusers" width="100" class="xxk_all_a"><a href="queryMailBoxListUserInit.do">用户与用户</a></td>
					<td width="1">&nbsp;</td>
					<td id="blacklist" width="100" class="main_alll_h2"><a href="queryBlacklistInit.do">黑名单</a></td>
					<td width="2">&nbsp;</td>
					<td width="2">&nbsp;</td>
					<td >&nbsp;</td>
				</tr>
					...
					<tbody>
					  <tr>
							<td class="f66" align="left" width="80%" height="36px">
								用户名：<input id="sender" name="paramMap.username" type="text"/>&nbsp;&nbsp;
