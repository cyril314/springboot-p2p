					...
					<div class="tab">
						<table cellspacing="1" cellpadding="3">
							...
							<tr>
								<td  class="blue12 left">
									奖励：
									<c:if test="borrowCirculationDetail.excitationType==3">${borrowCirculationDetail.excitationSum}%</c:if>
									<c:if test="borrowCirculationDetail.excitationType==2">${borrowCirculationDetail.excitationSum}元</c:if>
										<c:if test="borrowCirculationDetail.excitationType==1">无</c:if>
								</td>
