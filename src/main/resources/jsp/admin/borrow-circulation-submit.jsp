		...
		<div style="padding: 15px 10px 0px 10px;">
			<div>
				<table width="200" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="100" height="28" align="center" class="xxk_all_a">
							<a href="publishCirculation.do">代发流转标</a>
						</td>
						<td width="2">&nbsp;</td>
						<td width="100" align="center"  class="main_alll_h2">添加代发流转标</td>
						<td>&nbsp;</td>
					</tr>
				</table>
			</div>
			<div style="width: auto; background-color: #FFF; padding: 10px;">
				<table width="100%" border="0" cellspacing="1" cellpadding="3">
					<tr>
						<td style="height: 25px;" align="right" class="blue12">借款标题：</td>
						<td align="left" class="f66">
						    <s:textfield name="paramMap.title" theme="simple" cssClass="in_text_2" cssStyle="width: 150px" ></s:textfield>
							<span style="color: red;">*<s:fielderror fieldName="paramMap['title']" /></span>
						</td>
					</tr>
					<tr>
						<td style="width: 100px; height: 25px;" align="right" class="blue12">借款图片：</td>
						<td align="left" class="f66">
						    ...
						    <span style="color: red;">*<s:fielderror fieldName="paramMap['img']" /></span>
						</td>
					</tr>
					<tr>
						<td style="width: 100px; height: 25px;" align="right" class="blue12">借款标的：</td>
						<td align="left" class="f66"><span style="color: red;">流转标借款</span></td>
					</tr>
					<tr>
						<td style="height: 25px;" align="right" class="blue12">借款目的：</td>
						<td align="left" class="f66">
							...
							<span style="color: red;">*<s:fielderror fieldName="paramMap['purpose']" /></span>
						</td>
					</tr>
					<tr>
						<td style="height: 25px;" align="right" class="blue12">回购期限：</td>
						<td align="left" class="f66">
							...
							<span style="color: red;"><s:fielderror fieldName="paramMap['deadLine']" /></span>
						</td>
					</tr>
					<tr>
						<td style="width: 100px; height: 25px;" align="right" class="blue12">还款方式：</td>
						<td align="left" class="f66"><span style="color: red;">*一次性</span></td>
					</tr>
					<tr>
						<td style="width: 100px; height: 25px;" align="right" class="blue12">借款总额：</td>
						<td align="left" class="f66">
							...
							<s:textfield name="paramMap.amount" theme="simple" cssClass="in_text_2" cssStyle="width: 150px" ></s:textfield>
							<span style="color: red;">*<s:fielderror fieldName="paramMap['amount']" /></span>
							 【借款总额】的金额范围<a style="color: red;">${paramMap.borrowMoneyfirst }~${paramMap.borrowMoneyend }元，而且是${paramMap.accountmultiple }的倍数</a>
						</td>
					</tr>
					<tr>
						<td style="width: 100px; height: 25px;" align="right" class="blue12">年利率：</td>
						<td align="left" class="f66">
							...
							<s:textfield name="paramMap.annualRate" theme="simple" cssClass="in_text_2" cssStyle="width: 150px" ></s:textfield>
							<span style="color: red;">*<s:fielderror fieldName="paramMap['annualRate']" /></span>
							 【年利率】的比率范围<a style="color: red;">${paramMap.aprfirst }~${paramMap.aprend }%</a>
						</td>
					</tr>
					<tr>
						<td style="width: 100px; height: 25px;" align="right" class="blue12">最小流转单位：</td>
						<td align="left" class="f66">
							<s:textfield name="paramMap.smallestFlowUnit" theme="simple" cssClass="in_text_2" cssStyle="width: 150px" ></s:textfield>
							<span style="color: red;">*<s:fielderror fieldName="paramMap['smallestFlowUnit']" /></span>
						</td>
					</tr>
					<tr>
						<td style="width: 100px; height: 25px;" align="right" class="blue12">商业详情：</td>
						<td align="left" class="f66">
						    <s:textarea name="paramMap.businessDetail" theme="simple" cols="30" rows="10"></s:textarea>
							<span style="color: red;">*<s:fielderror fieldName="paramMap['businessDetail']" /></span>
						</td>
					</tr>
					<tr>
						<td style="width: 100px; height: 25px;" align="right" class="blue12">资产情况：</td>
						<td align="left" class="f66">
						    <s:textarea name="paramMap.assets" theme="simple" cols="30" rows="10"></s:textarea>
							<span style="color: red;">*<s:fielderror fieldName="paramMap['assets']" /></span>
						</td>
					</tr>
					<tr>
						<td style="width: 100px; height: 25px;" align="right" class="blue12">资金用途：</td>
						<td align="left" class="f66">
						    <s:textarea name="paramMap.moneyPurposes" theme="simple" cols="30" rows="10"> </s:textarea>
							<span style="color: red;">*<s:fielderror fieldName="paramMap['moneyPurposes']" /></span>
						</td>
					</tr>
					<!--  -->
					<tr><th> 投标奖励</th></tr>
     					<!-- <tr>
						<td style="width: 100px; height: 25px;" align="right" class="blue12">不设置奖励</td>
						<td align="left" class="f66">
						    <s:textarea name="paramMap.moneyPurposes" theme="simple" cols="30" rows="10"></s:textarea>
							<span style="color: red;">*<s:fielderror fieldName="paramMap['moneyPurposes']" /></span>
						</td>
					...
					<tr>
				    	...
				    	<td><input type="radio" name="excitationType" checked="checked" id="radio_1" value="1" />不设置奖励</td>
					</tr>
					<tr>
						<td align="right">&nbsp;</td>
						<td>
							...
							元<br />(奖励金额在<a style="color: red;">${paramMap.accountfirst }~${paramMap.accountend }</a>
							元区间【固定总额奖励】)<a style="color: red;"><s:fielderror fieldName="paramMap['sum']"></s:fielderror></a>
   						</td>
					</tr>
					<tr>
						...
						<td>
							...
							%<br />(奖励比例在<a style="color: red;">${paramMap.scalefirst }~${paramMap.scaleend }%</a>
							区间【借款总额比例奖励】)<a style="color: red"><s:fielderror fieldName="paramMap['sumRate']"></s:fielderror></a>
						</td>
					</tr>
							<!--  -->
					<tr>
					...
					<tr>
						...
						<td>
                           	...
                           	&nbsp;<span style="color: red;"><s:fielderror fieldName="actionMsg" theme="simple"></s:fielderror></span>
                        </td>
					</tr>
				</table>
				<br />
