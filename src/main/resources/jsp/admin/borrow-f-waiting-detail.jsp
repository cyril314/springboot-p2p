					...
					<div class="tab">
						<table cellspacing="1" cellpadding="3">
							...
							<tr>
								<td class="blue12 left">
									还款方式：
									<c:if test="%{borrowMFADetail.paymentMode ==1}">
									   按月分期还款
									</c:if>
								...
								<td class="f66 leftp200">
								标的类型：
							<c:if test="%{borrowMFADetail.borrowWay==1}">
							净值借款
							</c:if>
							...
							<s:else>
									...
									<td class="f66 leftp200">
	                                                                                                最高投标金额：
	                                    <c:if test="%{borrowMFADetail.maxTenderedSum==-1}">
								                           没有限制
								        </c:if>
								        <s:else>
							...
							<tr>
								<td class="blue12 left">
									投标奖励:  
									<c:if test="%{borrowMFADetail.excitationType ==2}">
							...
							<tr>
								<td class="blue12 left">
									投标密码：
									<c:if test="%{borrowMFADetail.hasPWD ==1}">
									   有
									</c:if>
									<s:else>
									   无
