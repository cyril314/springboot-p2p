...
<div style="padding: 15px 10px 0px 10px;">
		<table id="gvNews" style="width: 100%; color: #333333;"
			...
			<tbody>
				...
				<td  colspan="2" >￥<c:if test="%{#request.waitTotalAmount.totalWaitBorrowAmount==''}">0</c:if><s:else>
		                <c:out value="#request.waitTotalAmount.totalWaitBorrowAmount" default="0"/></s:else>
		                </td>		
				</tr>
			</tbody>
		</table>
