...
<html>
	<head>
		...
		<link href="${ctx}/static/css/admin/admin_css.css" rel="stylesheet"
			type="text/css" />
		<link href="${ctx}/static/css/admin/admin_custom_css.css" rel="stylesheet"
			type="text/css" />
	</head>
	<body>
		<div id="right">
						...
						<tbody>
							<tr>
								<td class="f66" align="left" width="50%" height="36px">
									...
									&nbsp;&nbsp; 时间:
									<input id="timeStart" class="Wdate" value=""
...
/>
	...
	$(function() {
		...
		$("#excel")
				.click(
						function() {
							window.location.href = encodeURI(encodeURI("exportborrowStatisInterest.do?investor="
									+ $("#investor").val()
									+ "&&timeStart="
									+ $("#timeStart").val()
									+ "&&timeEnd="
