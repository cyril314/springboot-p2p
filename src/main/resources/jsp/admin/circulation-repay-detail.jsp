	...
	<body>
					...
					<div class="tab">
						<table cellspacing="1" cellpadding="3">
							...
							<tr>
								...
								<td class="f66 leftp200">
                                                                                               还款状态：<c:if test="%{paramMap.repayStatus == 1}">未偿还</c:if>
							...
							<tr>
								<td class="blue12 left" colspan="2">
								    ...
								    <c:if test="%{paramMap.repayStatus == 1}">
		...
		<table id="gvNews" style="width: 100%; color: #333333;"
			...
			<tbody>
				...
				<c:if test="cirList==null || cirList.size==0">
				...
				<tr class=gvHeader>
				 ...
				 <c:if test="%{#request.investList !=null && #request.investList.size()>0}">
                    <s:iterator value="#request.investList" id="investList">
							...
							<tr class="gvItem">
						<td>
							 <c:out value="#investList.username" default="---"/>
						</td>
						<td>
							￥<c:out value="#investList.investAmount"/>
						</td>
						<td>
							<c:out value="#investList.investTime"/>
						</td>
					</tr>
					</s:iterator>
					</c:if>
