...
<%@ include file="../include/taglib.jsp"%>
	...
	<table id="gvNews" style="width: 100%; color: #333333;" cellspacing="1" cellpadding="3" bgcolor="#dee7ef" border="0">
		<tbody>
			...
			<c:if test="#request.collectionList==null || #request.collectionList.size==0">
				<tr align="center" class="gvItem"><td colspan="5">暂无数据</td></tr>
			</c:if>
			<s:else>
			<s:iterator value="#request.collectionList" var="collection">
				<tr class="gvItem">
					...
					<td><a href="delCollection?id=${collection.id}">删除</a>	</td>
				</tr>
			</s:iterator>
			</s:else>
		</tbody>
