	...
	<table id="gvNews" style="width: 100%; color: #333333;" cellspacing="1"
		...
		<tbody>
			<tr class=gvHeader>
				...
				<th scope="col">期限	</th>
				<th scope="col">年利率</th>
				<th scope="col">债权期限	</th>
				<th scope="col">投资金额	</th>
				<th scope="col">竞拍底价	</th>
				<th scope="col">竞拍最高价</th>
				<th scope="col">竞拍者</th>
			...
			<s:else>
				...
				<s:iterator value="pageBean.page" var="bean" status="s">
					<tr class="gvItem">
						...
						<td>
							<c:if test="auctionHighPrice != null">
								<a id="chengjiao" onclick="chengjiao(${id});" href="javascript:void(0)">成交</a>
							</c:if>
							<a href="${basePath}/queryDebtDetail.do?id=${id}" target="_blank">查看</a>
