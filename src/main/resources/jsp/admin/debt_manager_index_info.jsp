	...
	<div>
		<table id="gvNews" style="width: 100%; color: #333333;"
			...
			<tbody>
				...
				<td  colspan="2" >￥
				<c:if test="%{#request.repaymentMap.applydebtSum==''}">0</c:if>
				<s:else> <c:out value="#request.repaymentMap.applydebtSum" default="0"/></s:else>
