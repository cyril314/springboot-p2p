...
<div style="padding: 15px 10px 0px 10px;">
		<table id="gvNews" style="width: 100%; color: #333333;" cellspacing="1" cellpadding="3" bgcolor="#dee7ef" border="0">
			<tbody>
				...
				<td  colspan="2" >￥<c:if test="#request.repaymentMap.amount==''">0</c:if><s:else>${repaymentMap.amount}</s:else></td>
		...
		<span class="require-field">待还款总合计:￥<c:if test="#request.repaymentMap.amount==''">0</c:if><s:else>${repaymentMap.amount}</s:else>元</span>
-->
</div>
