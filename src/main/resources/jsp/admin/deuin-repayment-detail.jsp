...
<div class="box" style="border:none;">
  ...
  <tr>
	...
	<s:iterator value="pageBean.page" var="bean">
	 <tr>
	   <td align="center"><c:if test="%{#bean.isWebRepay == 2}">网站垫付</c:if><s:else>${bean.borrowName}</s:else></td>
	   ...
	   <td align="center"><c:if test="%{#bean.isWebRepay == 1}">否</c:if><s:else>是</s:else></td>
