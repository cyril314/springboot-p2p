    ...
    <input type="hidden" value="adminlogin" name="pageId" />
         <div style="width: 100%; overflow: hidden;">
            <div style="float: left; width: 100%; text-align: left; padding:120px 0px 5px 0px;">
                <strong style=" width:518px; margin:0 auto; display:block;"><img src="static/images/admin/sp2p.png" border="0"/><img src="static/images/admin/logo.png" border="0"/></strong>
            </div>
          </div>
                        ...
                        <table width="518" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td style="padding: 25px 0px 0px 0px;">
                                    <input type="submit" value="确认" id="btnLogin" style="background:url(static/images/admin/login_menu.png); width:100px; height:32px; line-height:32px; color:#fff; font-size:14px; font-weight:bold;"/>
                                </td>
                            </tr>
                        </table>
                    </div>
