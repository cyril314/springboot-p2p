				...
				<tr>
					<td>
						...
						<div id="submenu${sta.index}" class="munes">
                           <ul>
							<s:iterator	value="#session.adminRoleMenuList.{?#this.parentId==#session.index}" var="sBean">
								<li><a href="${sBean.action }" target="main"><span class="point">&raquo;</span>${sBean.summary }</a></li>
							</s:iterator>
                           </ul>
						</div>
					</td>
