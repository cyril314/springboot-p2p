...
<body>
	<div style="width: 100%; overflow: hidden; height:80px; background: url(static/images/admin/navbg.gif) repeat-x; overflow: hidden; border-top:3px solid #3ca1d6;">
		<div class="white14" style="float: left; width:180px; text-align: left; height:40px; overflow: hidden;">
			<a href="../index.jsp" target="_blank"><img src="static/images/admin/logo.png" border="0" style="margin-top:5px;"/></a>
		</div>
		<div class="daohang_all">
              	<ul>
			<s:iterator value="#session.adminRoleMenuList.{?#this.rightsId<0}" var="bean" status="sta">
				<c:if test="#bean.rightsId == -11"></c:if>
				<s:else>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td height="16" width="300px;" class="black12">
						<img src="static/images/admin/icon_tx.gif" height="16" style="vertical-align:-3px;"/>
