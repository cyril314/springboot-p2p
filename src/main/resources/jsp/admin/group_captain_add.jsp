		...
		<script type="text/javascript" language="javascript">
	    	...
	    	init();
				...
				$("#btn_save").click(function(){
				  if($("#gTip").html()==""){//add by houli，在业务机构帐户填写正确的情况下才进行提交
					$(this).hide();
					$("#addAdmin").submit();
					return false;
					}
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
							<tr>
								...
								<td align="left" class="f66">
									<s:textfield  id="gName"  name="paramMap.userName" theme="simple" maxlength="20"
							...
							<tr>
								...
								<td align="left" class="f66">
									<s:textfield name="paramMap.realName" theme="simple" maxlength="20"
										cssClass="in_text_2" cssStyle="width: 150px" ></s:textfield>
									<span style="color: red;">*<s:fielderror
							...
							<tr>
								...
								<td align="left" class="f66">
									<s:textfield name="paramMap.card" theme="simple" maxlength="18"
										cssClass="in_text_2" cssStyle="width: 150px" ></s:textfield>
									<span style="color: red;">*<s:fielderror
							...
							<tr>
								...
								<td align="left" class="f66">
									<s:textfield name="paramMap.telphone" theme="simple" maxlength="11"
										cssClass="in_text_2" cssStyle="width: 150px" ></s:textfield>
									<span style="color: red;">*<s:fielderror
							...
							<tr>
								...
								<td>
                                <input type="button" id="btn_save" style="background-image: url('static/images/admin/btn_queding.jpg');width: 70px;border: 0;height: 26px"  ></input>
