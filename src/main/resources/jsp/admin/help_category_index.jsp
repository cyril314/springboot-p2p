						...
						<div>
							<table id="gvItem" style="width: 100%; color: #333333;"
								...
								<tbody>
									...
									<c:if test="#request.typeList.size > 0">
						  ...
						  <tbody>
								  <tr>
			                            <td height="36" align="right" class="blue12">
			                                &nbsp;</td>
			                            <td align="right">
			                                  <button  id="btnSave" style="background-image: url('static/images/admin/btn_queding.jpg');width: 70px;border: 0;height: 26px" onclick="saveOrder();" ></button>
