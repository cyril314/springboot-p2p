							...
							<tr>
								...
								<td align="left" class="f66">
									<input type="radio" name="state" value="2" 
									   		<c:if test='paramMap.state == 2'>checked="checked"</c:if>
																					<s:else></s:else>
									    />开启 
									 <input type="radio" name="state" value="1"
									    <c:if test='paramMap.state == 1'>checked="checked"</c:if>
																					<s:else></s:else>
									    />隐藏
								</td>
							</tr>
							<tr>
								...
								<td align="left" class="f66">
									<input type="radio" name="stick" value="2" 
									   		<c:if test='paramMap.stick == 2'>checked="checked"</c:if>
																					<s:else></s:else>
									    />是
									 <input type="radio" name="stick" value="1"
									    <c:if test='paramMap.stick == 1'>checked="checked"</c:if>
																					<s:else></s:else>
									    />否
								</td>
							</tr>
