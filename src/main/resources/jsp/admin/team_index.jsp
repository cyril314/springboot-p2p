		...
		<script type="text/javascript">
			...
			function initListInfo(praData){	
				...
				param["paramMap.state"]= '${paramMap.state}';	 
		 		$.shovePost("queryTeamListPage.do",param,initCallBack);
		 	}
			...
			function dels(){
		 	...
		 	function del(id,state){
	 			...
	 			window.location.href= "deleteTeam.do?id="+id+"&state="+state;
		 	}
		 	...
		 	function preview(id,state){
		 	  var url = "previewTeamInit.do?id="+id+"&state="+state;
						...
						<tr>
							<td width="100" height="28"  class="main_alll_h2">		
								<a href="teamListinit.do?state=${paramMap.state }">
									<c:if test="#request.paramMap.state==1">管理团队</c:if>
									<s:else>专家顾问</s:else>
								</a>							
							</td>
							<td width="2">
							...
							<td width="100"  class="xxk_all_a">
								<a href="addTeamInit.do?state=${paramMap.state }">添加成员</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
