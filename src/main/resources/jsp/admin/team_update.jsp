...
<html>
	...
	<s:hidden id="sort_" name="paramMap.sort"></s:hidden>
		<form id="updateTeam" name="updateTeam" action="updateTeam.do?state=${paramMap.state }" method="post">
						...
						<table  border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="100" height="28" class="xxk_all_a">
									<a href="teamListinit.do?state=${paramMap.state }">
										<c:if test="#request.paramMap.state==1">
											团队管理
										</c:if>
										<s:else>专家顾问</s:else>
								...
								<td width="100"  class="main_alll_h2">
									<a href="updateTeamInit.do?id=${paramMap.id}&state=${paramMap.state }">修改成员</a>
								</td>
								<td>
									&nbsp;
								</td>
