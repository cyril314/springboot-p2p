        ...
        <div id="right">
            ...
            <div style="width: auto; background-color: #FFF; padding: 20px;">
                <table width="800" border="0" cellspacing="1" cellpadding="3" align="center">
                    <tr>
                        <td style="width: 100px; height: 30px;" align="right" class="blue12"> 提醒类型：</td>
                        <td align="left" class="f66"> ${bean.title } </td>
                    </tr>
                    <tr>
                        <td style="width: 100px; height: 30px;" align="right" class="blue12"> 标示名：</td>
                        <td align="left" class="f66"> ${bean.nid } </td>
                    </tr>
                    <tr>
                        <td style="width: 100px; height: 30px;" align="right" class="blue12"> 名称：</td>
                    ...
                    <tr>
                        ...
                        <td align="left" class="f66">
                            ...
                            <span class="require-field">*带有“[]”字符的为系统调用字符，不可修改。谢谢配合！<s:fielderror
                                    fieldName="title"></s:fielderror></span>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 100px; height: 30px;" align="right" class="blue12">
                            排序：
                        </td>
                        <td align="left" class="f66">
                    ...
                    <tr>
                        ...
                        <td>
                            <input style="background-image: url('static/images/admin/btn_queding.jpg'); width: 70px; border: 0; height: 26px"
                                   id="btn_save" type="button"/>
