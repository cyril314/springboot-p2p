		      ...
		      //提交表单
				$("#btn_save").click(function(){
					...
					if($("#tb_description").val()==""){
						...
						return false;
					}else if($("#tb_description").val().length>255){
						$("#description").html(" * 请填写长度不大于255的描述");
						return false;
					}else{
						$("#description").html("*");
					}
						...
						<table width="800" border="0" cellspacing="1" cellpadding="3"  align="center" >
							...
							<tr>
								...
								<td align="left" class="f66">
									...
									<span class="require-field" id="description"><s:fielderror fieldName="paramMap['tb_description']"></s:fielderror></span>
								</td>
							</tr>
							<tr>
