...
<html>
	...
	<body>
		<form id="updateShovetypes" name="updateShovetypes"
			action="updateShoveTypeInfo.do" method="post">
			<div id="right">
					...
					<table width="800" border="0" cellspacing="1" cellpadding="3"
						...
						<tr>
							...
							<td align="left" class="f66">
								...
								<span class="require-field" id="title">*<s:fielderror
										fieldName="title"></s:fielderror>
								</span>
							</td>
						</tr>
						<tr>
							...
							<td align="left" class="f66">
								<s:textarea name="paramMap.description" cols="40" rows="5"
									id="description" />
								<span class="require-field"><s:fielderror
										fieldName="paramMap['description']"></s:fielderror>
								</span>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td align="left" class="f66">
								<s:iterator value="#request.mapTypeList" var="mapType"
									status="st">
									<input type="radio" name="paramMap_amount_type"
										value="${mapType.id}"
										<c:if test='paramMap.amount_type == #mapType.id'>checked="checked"</c:if>
										<s:else>
									</s:else> />${mapType.title }&nbsp;&nbsp;
								</s:iterator>
								<span class="require-field"><s:fielderror
										fieldName="paramMap['contents']"></s:fielderror>
								</span>
							</td>
						</tr>
						<tr>
							...
							<td align="left" class="f66">
								...
								<s:textfield id="tb_amount_end" name="paramMap.amount_end"
									cssClass="in_text_50" theme="simple" />
								元
								<span class="require-field" id="amount_first">*<s:fielderror
										fieldName="title"></s:fielderror>
								</span>
							</td>
						</tr>
						<tr>
							...
							<td align="left" class="f66">
								<s:textfield id="tb_account_multiple"
									name="paramMap.account_multiple" cssClass="in_text_50"
									theme="simple" />
								元 (0表示不限)
								<span class="require-field" id="account_multiple">*<s:fielderror
										fieldName="title"></s:fielderror>
								</span>
							</td>
						</tr>
						<tr>
							...
							<td align="left" class="f66">
								...
								<s:textfield id="tb_apr_end" name="paramMap.apr_end"
									cssClass="in_text_50" theme="simple" />
								%
								<span class="require-field" id="apr_first">*<s:fielderror
										fieldName="title"></s:fielderror>
								</span>
							</td>
						</tr>
						<tr>
							...
							<td align="left" class="f66">
								<s:textfield id="tb_validate" name="paramMap.validate"
									cssClass="in_text_250" theme="simple" />
								天(多天请用,号隔开，0 表示无限期)
								<span class="require-field" id="validate">*<s:fielderror
										fieldName="title"></s:fielderror>
								</span>
							</td>
						</tr>
						<tr style="display: none;">
							...
							<td align="left" class="f66">
								...
								<s:textfield id="tb_check_end" name="paramMap.check_end"
									cssClass="in_text_50" theme="simple" />
								天
								<span class="require-field" id="check_first">*<s:fielderror
										fieldName="title"></s:fielderror>
								</span>
							</td>
						</tr>
						<tr style="display: none;">
							...
							<td align="left" class="f66">
								<s:textfield id="tb_tender_account_min"
									name="paramMap.tender_account_min" cssClass="in_text_250"
									theme="simple" />
								元(多个请用,号隔开)
								<span class="require-field" id="tender_account_min">*<s:fielderror
										fieldName="title"></s:fielderror>
								</span>
							</td>
						</tr>
						<tr style="display: none;">
							...
							<td align="left" class="f66">
								<s:textfield id="tb_account_max"
									name="paramMap.tender_account_max" cssClass="in_text_250"
									theme="simple" />
								元(多个请用,号隔开)
								<span class="require-field" id="account_max">*<s:fielderror
										fieldName="title"></s:fielderror>
								</span>
							</td>
						</tr>
						<tr>
							...
							<td align="left" class="f66">
								<c:if test="%{'flow' eq paramMap.nid}">
									<input type="radio" name="paramMap_password_status" value="2"
										checked="checked" />关闭
								</c:if>
								<s:else>
									<input type="radio" name="paramMap_password_status" value="1"
										<c:if test='paramMap.password_status == 1'>checked="checked"</c:if>
										<s:else></s:else> />开启 
									 <input type="radio" name="paramMap_password_status" value="2"
										<c:if test='paramMap.password_status == 2'>checked="checked"</c:if>
										<s:else></s:else> />关闭
								 </s:else>
							</td>
						</tr>
						...
						<tr>
							...
							<td align="left" class="f66">
								03个月：
								<input type="radio" name="paramMap.deadline_s3" value="1"
									<c:if test='paramMap.deadline_s3 == 1'>checked="checked"</c:if>
									<s:else></s:else> />开启 
								 <input type="radio" name="paramMap.deadline_s3" value="2"
									<c:if test='paramMap.deadline_s3 == 2'>checked="checked"</c:if>
									<s:else></s:else> />关闭
								| 
								投资奖励金额  = 投资金额 *
								<s:textfield id="excitationSumRate_b3"
									name="paramMap.excitationSumRate_b3" cssClass="in_text_50"
									theme="simple" />% (0为不奖励)
							</td>
						</tr>
						...
						<tr>
							...
							<td align="left" class="f66">
								06个月：
								<input type="radio" name="paramMap.deadline_s6" value="1"
									<c:if test='paramMap.deadline_s6 == 1'>checked="checked"</c:if>
									<s:else></s:else> />开启 
								 <input type="radio" name="paramMap.deadline_s6" value="2"
									<c:if test='paramMap.deadline_s6 == 2'>checked="checked"</c:if>
									<s:else></s:else> />关闭
								| 
								投资奖励金额  = 投资金额 *
								<s:textfield id="excitationSumRate_b6"
									name="paramMap.excitationSumRate_b6" cssClass="in_text_50"
									theme="simple" />% (0为不奖励)
							</td>
						</tr>
						...
						<tr>
							...
							<td align="left" class="f66">
								09个月：
								<input type="radio" name="paramMap.deadline_s9" value="1"
									<c:if test='paramMap.deadline_s9 == 1'>checked="checked"</c:if>
									<s:else></s:else> />开启 
								 <input type="radio" name="paramMap.deadline_s9" value="2"
									<c:if test='paramMap.deadline_s9 == 2'>checked="checked"</c:if>
									<s:else></s:else> />关闭
								| 
								投资奖励金额  = 投资金额 *
								<s:textfield id="excitationSumRate_b9"
									name="paramMap.excitationSumRate_b9" cssClass="in_text_50"
									theme="simple" />% (0为不奖励)
							</td>
						</tr>
						...
						<tr>
							...
							<td align="left" class="f66">
								12个月：
								<input type="radio" name="paramMap.deadline_s12" value="1"
									<c:if test='paramMap.deadline_s12 == 1'>checked="checked"</c:if>
									<s:else></s:else> />开启 
								 <input type="radio" name="paramMap.deadline_s12" value="2"
									<c:if test='paramMap.deadline_s12 == 2'>checked="checked"</c:if>
									<s:else></s:else> />关闭
								| 
								投资奖励金额  = 投资金额 *
								<s:textfield id="excitationSumRate_b12"
									name="paramMap.excitationSumRate_b12" cssClass="in_text_50"
									theme="simple" />% (0为不奖励)
							</td>
						</tr>
						...
						<tr>
							...
							<td align="left" class="f66">
								18个月：
								<input type="radio" name="paramMap.deadline_s18" value="1"
									<c:if test='paramMap.deadline_s18 == 1'>checked="checked"</c:if>
									<s:else></s:else> />开启 
								 <input type="radio" name="paramMap.deadline_s18" value="2"
									<c:if test='paramMap.deadline_s18 == 2'>checked="checked"</c:if>
									<s:else></s:else> />关闭
								| 
								投资奖励金额  = 投资金额 *
								<s:textfield id="excitationSumRate_b18"
									name="paramMap.excitationSumRate_b18" cssClass="in_text_50"
									theme="simple" />% (0为不奖励)
							</td>
						</tr>
						...
						<tr>
							...
							<td align="left" class="f66">
								24个月：
								<input type="radio" name="paramMap.deadline_s24" value="1"
									<c:if test='paramMap.deadline_s24 == 1'>checked="checked"</c:if>
									<s:else></s:else> />开启 
								 <input type="radio" name="paramMap.deadline_s24" value="2"
									<c:if test='paramMap.deadline_s24 == 2'>checked="checked"</c:if>
									<s:else></s:else> />关闭
								| 
								投资奖励金额  = 投资金额 *
								<s:textfield id="excitationSumRate_b24"
									name="paramMap.excitationSumRate_b24" cssClass="in_text_50"
									theme="simple" />% (0为不奖励)
							</td>
						</tr>
						...
						<tr>
							...
							<td align="left" class="f66">
								<s:textfield id="tb_vip_frost_scale"
									name="paramMap.vip_frost_scale" cssClass="in_text_50"
									theme="simple" />
								%
								<span class="require-field" id="vip_frost_scale">*<s:fielderror
										fieldName="title"></s:fielderror>
								</span>
							</td>
						</tr>
						<tr>
							...
							<td align="left" class="f66">
								<s:textfield id="tb_all_frost_scale"
									name="paramMap.all_frost_scale" cssClass="in_text_50"
									theme="simple" />
								%
								<span class="require-field" id="all_frost_scale">*<s:fielderror
										fieldName="title"></s:fielderror>
								</span>
							</td>
						</tr>
						<tr>
							...
							<td align="left" class="f66">
								<s:textfield id="tb_late_days_month"
									name="paramMap.late_days_month" cssClass="in_text_50"
									theme="simple" />
								天
								<span class="require-field" id="late_days_month">*<s:fielderror
										fieldName="title"></s:fielderror>
								</span>
							</td>
						</tr>
						<tr style="display: none">
							...
							<td align="left" class="f66">
								<s:textfield id="tb_vip_late_scale"
									name="paramMap.vip_late_scale" cssClass="in_text_50"
									theme="simple" />
								%
								<span class="require-field" id="vip_late_scale">*<s:fielderror
										fieldName="title"></s:fielderror>
								</span>
							</td>
						</tr>
						<tr style="display: none">
							...
							<td align="left" class="f66">
								<s:textfield id="tb_all_late_scale"
									name="paramMap.all_late_scale" cssClass="in_text_50"
									theme="simple" />
								%
								<span class="require-field" id="all_late_scale">*<s:fielderror
										fieldName="title"></s:fielderror>
								</span>
							</td>
						</tr>
						<tr>
							...
							<td align="left" class="f66">
								<c:if test="%{paramMap.nid eq 'seconds'}">
									本金 * <s:textfield id="locan_fee" name="paramMap.locan_fee"
										cssClass="in_text_30" theme="simple" />%<span
										style="display: none;">+ 本金 *(期数 - <s:textfield
											id="locan_month" name="paramMap.locan_month"
											cssClass="in_text_30" theme="simple" />个月 )* <s:textfield
											id="locan_fee_month" name="paramMap.locan_fee_month"
											cssClass="in_text_30" theme="simple" />%</span>
								</c:if>
								...
								<s:else>
									本金 * <s:textfield id="locan_fee" name="paramMap.locan_fee"
										cssClass="in_text_30" theme="simple" />% + 本金 *(期数 - <s:textfield
										id="locan_month" name="paramMap.locan_month"
										cssClass="in_text_30" theme="simple" />个月 )* <s:textfield
										id="locan_fee_month" name="paramMap.locan_fee_month"
										cssClass="in_text_30" theme="simple" />%
								</s:else>
								<span class="require-field" id="t_locan_fee">*<s:fielderror
										fieldName="title"></s:fielderror>
								</span>
								<br />
								<span> <c:if test="%{paramMap.nid eq 'seconds'}">
								本金 *  借款管理费  
								</c:if> <s:elseif test="%{paramMap.nid eq 'flow'}">
								本金 *  借款管理费  
								</s:elseif> <s:else>
							...
							<td align="left" class="f66">
								...
								<s:else>
									<s:iterator value="#request.mapList" var="map" status="st">
										<input type="checkbox" name="paramMapStyles"
											value="${map.id }"
											<s:iterator value="#request.arr"  var="type" status="stat">
									   		<c:if test='#map.id == #request.arr[#stat.index]'>checked="checked"</c:if>
																					<s:else></s:else>
										</s:iterator> />${map.title } &nbsp;
									  </s:iterator>
									<span class="require-field" id="style_id">*<s:fielderror
											fieldName="title"></s:fielderror>
									</span>
								</s:else>
							</td>
						...
						<tr>
							<td height="36" align="right" class="blue12">
								...
								<input type="hidden" value="${paramMap.id}" name="paramMap.id"
									id="paramMap.id" />
								&nbsp;
							</td>
							<td>
