					...
					<div id="showcontent" style="width: auto; background-color: #FFF; padding: 10px;">
						...
						<table  border="0" cellspacing="1" cellpadding="3" >
										...
										<input type="radio" name="radio" id="sex" value="男"
												...
												<s:else></s:else>
													...
													<input type="radio" name="radio" id="sex" value="女" disabled="disabled"
														name="paramMap.sex" 	<c:if test='#request.map.sex == "女"'>checked="checked"</c:if>
												<s:else></s:else> />
													女
								</td> 	
							...
							最高学历：
								...
								<td align="left" class="f66">-->
										<select name="paramMap.highestEdu" id="highestEdu" disabled="disabled" >
														...
														<option value="博士" 
														<c:if test='#request.map.highestEdu == "博士"'>selected="selected"</c:if>
														<s:else></s:else>
														>
															博士
														</option>
														<option value="研究生"
															<c:if test='#request.map.highestEdu == "研究生"'>selected="selected"</c:if>
														<s:else></s:else>
														>
															研究生
														</option>
							...
							个人头像：
								<!--</td>
								<td align="left" class="f66">-->
										<c:if test="#request.map.personalHead==null||#request.map.personalHead==''">
