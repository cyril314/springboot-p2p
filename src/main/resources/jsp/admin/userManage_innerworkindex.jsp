			...
			<table border="0" cellspacing="1" cellpadding="3" width="100%">
				<tr>
					<td height="60">
						<table>
							<tr>
								<td class="xxk_all_a" align="center" width="100" >
								...
								<td class="main_alll_h2" width="100" align="center">
									<a style="cursor: pointer;" id="li_work">工作信息</a>
								</td>
								<td>
									&nbsp;
								</td>
								<td class="xxk_all_a1" width="100" align="center">
									<a href="queryUserManageInvest.do?i=${UserMsgmap.id}"
				...
				<td align="center" width="100%">
					<table  border="1" cellspacing="1" cellpadding="3" width="100%">
							...
							<tr>
								...
								<td align="left" class="f66">
									<select name="paramMap.occStatus" id="occStatus"
										disabled="disabled">
										<option value=""
											<c:if test='#request.map.occStatus == ""'>selected="selected"</c:if>
											<s:else></s:else>>
											请选择
										</option>
										<option value="工薪阶层"
							...
							<tr>
								...
								<td align="left" class="f66">
									<select id="companyType" name="paramMap.companyType"
										disabled="disabled">
										<option value=""
											<c:if test='#request.map.companyType == ""'>selected="selected"</c:if>
											<s:else></s:else>>
											请选择
										</option>
										<option value="事业单位"
							...
							<tr>
								...
								<td>
									<select id="companyLine" name="paramMap.companyLine"
										disabled="disabled">
										<option value=""
											<c:if test='#request.map.companyLine == ""'>selected="selected"</c:if>
											<s:else></s:else>>
											请选择
										</option>
										<option value="事业单位"
											<c:if test='#request.map.companyLine == "事业单位"'>selected="selected"</c:if>
											<s:else></s:else>>
											事业单位
										</option>
										<option value="国家单位"
											<c:if test='#request.map.companyLine == "国家单位"'>selected="selected"</c:if>
											<s:else></s:else>>
											国家单位
										</option>
										<option value="央企(包括下级单位)"
											<c:if test='#request.map.companyLine == "央企(包括下级单位)"'>selected="selected"</c:if>
											<s:else></s:else>>
											央企(包括下级单位)
										</option>
										<option value="地方国资委直属企业"
											<c:if test='#request.map.companyLine == "地方国资委直属企业"'>selected="selected"</c:if>
											<s:else></s:else>>
											央企(包括下级单位)
										</option>
										<option value="世界500强(包括合资企业及下级单位)"
											<c:if test='#request.map.companyLine == "世界500强(包括合资企业及下级单位)"'>selected="selected"</c:if>
											<s:else></s:else>>
											世界500强(包括合资企业及下级单位)
										</option>
										<option value="外资企业(包括合资企业)"
											<c:if test='#request.map.companyLine == "外资企业(包括合资企业)"'>selected="selected"</c:if>
											<s:else></s:else>>
											外资企业(包括合资企业)
										</option>
										<option value="一般上市公司(包括国外上市公司)"
											<c:if test='#request.map.companyLine == "一般上市公司(包括国外上市公司)"'>selected="selected"</c:if>
											<s:else></s:else>>
											一般上市公司(包括国外上市公司)
										</option>
										<option value="一般民营企业"
											<c:if test='#request.map.companyLine == "一般民营企业"'>selected="selected"</c:if>
											<s:else></s:else>>
											一般民营企业
										</option>
									</select>
							...
							<tr>
								...
								<td>
									<input type="text" class="inp188" name="paramMap.job"
										disabled="disabled" id="job" value="${map.job }" />
								</td>
							</tr>
							<tr>
								<td height="36" align="right" class="blue12">
								...
								<td>
									<select name="paramMap.monthlyIncome" id="monthlyIncome"
										disabled="disabled">
										<option value=""
											<c:if test='#request.map.monthlyIncome == ""'>selected="selected"</c:if>
											<s:else></s:else>>
											请选择
										</option>
										<option value="1000以下"
							...
							<tr>
								...
								<td>
									<select name="paramMap.workYear" id="workYear"
										disabled="disabled">
										<option value=""
											<c:if test='#request.map.workYear == ""'>selected="selected"</c:if>
											<s:else></s:else>>
											请选择
										</option>
										<option value="1年"
							...
							<tr>
								...
								<td>
									<input type="text" class="inp188"
										name="paramMap.workEmail" disabled="disabled"
							...
							<tr>
								...
								<td>
									<input type="text" class="inp188"
										...
										value="${map.companyAddress }" disabled="disabled" />
								</td>
							</tr>
							<tr>
								<th colspan="2" align="left" height="36" class="blue12">
							...
							<tr>
								...
								<td>
									<input type="text" class="inp188"
										...
										value="${map.directedName }" disabled="disabled" />
								</td>
							</tr>
							<tr>
								<td height="36" align="right" class="blue12">
								...
								<td>
									<input type="text" class="inp188"
										...
										value="${map.directedRelation }" disabled="disabled" />
								</td>
							</tr>
							<tr>
								<td height="36" align="right" class="blue12">
								...
								<td>
									<input type="text" class="inp188"
										...
										value="${map.directedTel }" disabled="disabled" />
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<input type="text" class="inp188"
										name="paramMap.otherName" id="otherName"
										value="${map.otherName }" disabled="disabled" />
								</td>
							</tr>
							<tr>
								<td height="36" align="right" class="blue12">
								...
								<td>
									<input type="text" class="inp188"
										...
										value="${map.otherRelation }" disabled="disabled" />
								</td>
							</tr>
							<tr>
								<td height="36" align="right" class="blue12">
							...
							<tr>
								...
								<td>
									<input type="text" class="inp188"
										name="paramMap.moredName" id="moredName"
										value="${map.moredName }" disabled="disabled" />
								</td>
							</tr>
							<tr>
								<td height="36" align="right" class="blue12">
								...
								<td>
									<input type="text" class="inp188"
										...
										value="${map.moredRelation }" disabled="disabled" />
								</td>
							</tr>
