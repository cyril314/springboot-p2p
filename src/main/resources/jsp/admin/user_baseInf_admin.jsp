										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											...
											<tr>
												...
												<s:else></s:else> 
													...
													<c:if test='#request.flag == "1"'>disabled="disabled"</c:if>
												<s:else></s:else> 
												...
												<td class="tx">
                                                  <c:if test="#request.map.personalHead==null">
                                                  	<img id="img" src="../${headImg}" width="62" height="62"
														name="paramMap.personalHead" /></c:if>
	...
	//提交基础资料
	 ...
	 if($('#telephone').val()==""){
	   ...
	   if($("#img").attr("src")==""){
	    ...
	    //用户头像路径
	     var imgtemp = $("#img").attr("src"); 
        param["paramMap.personalHead"]=imgtemp.substring(3,imgtemp.length);
