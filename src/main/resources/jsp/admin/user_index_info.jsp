			...
			<tbody >
				...
				<s:iterator value="pageBean.page" var="bean" status="s">
					...
					<tr class="gvItem">
						...
						<td>
						<c:if test="#bean.tmIdentityauditStatus==1">
						 等待审核
						</c:if>
						...
						<c:if test="#bean.tmworkauditStatus==1">
						 等待审核
						</c:if>
						...
						<c:if test="#bean.tmresponseauditStatus==1">
						 等待审核
						</c:if>
						...
						<td>
											...
											<c:if test="#bean.tmaddressauditStatus==1">
						 等待审核
						</c:if>
						...
						<c:if test="#bean.tmincomeeauditStatus==1">
						 等待审核
						</c:if>
						...
						<td>
						<c:if test="#bean.serviceManName!=null">
						${serviceManName}
						</c:if>
						<s:else>
						未分配
