			...
			<tbody>
				...
				<s:iterator value="pageBean.page" var="bean" status="s">
					<tr class="gvItem">
						...
						<td><!--
						 个人信息状态 -->
                           <c:if test="#bean.personauditStatus==1">基本信息完整<a style="color: gray;">(待审核)</a></c:if>
						...
						<td>
						 工作信息状态 
						    <c:if test="#bean.workauditStatus==1">基本信息完整<a style="color: gray;">(待审核)</a></c:if>
						...
						<td>
						 联系信息审核 
							   ...
							   <c:if test="#bean.workauditStatus!=null">
							       <c:if test="#bean.directedStatus==1">
							       ...
							       <s:elseif test="#bean.directedStatus==3">
							            <c:if test="#bean.otherStatus==1">
							               基本信息完整<a style="color: gray;">(待审核)
							            </c:if>
							            <s:elseif test="#bean.otherStatus==2">
							               基本信息完整<a style="color: red;">(失败)</a>
							            </s:elseif>
							            <s:elseif test="#bean.otherStatus==3">
							                <c:if test="#bean.moredStatus==1">
							                    基本信息完整<a style="color: gray;">(待审核)
							                </c:if>
