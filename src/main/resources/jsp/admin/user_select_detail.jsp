...
<html>
	...
	<body>
					...
					<div class="tab">
						<table cellspacing="1" cellpadding="3">
							...
							<tr>
							    <td class="blue12 left">
							     身份证： 
							     <c:if test="#request.map.identifyStatus==1">待审核</c:if>
								...
								<td class="f66 leftp200">
								 工作认证：
								   <c:if test="#request.map.workStatus==1">待审核</c:if>
							...
							<tr>
								<td class="blue12 left">
									信用报告：
									  <c:if test="#request.map.responseStatus==1">待审核</c:if>
								...
								<td class="f66 leftp200">
								       居住认证：
								         <c:if test="#request.map.addrressStatus==1">待审核</c:if>
							...
							<tr>
								<td class="blue12 left">
									收入验证：
									  <c:if test="#request.map.incomeStatus==1">待审核</c:if>
			...
			<tbody>
							...
							<tr class="gvItem">
							<td>房产</td><td>
							<c:if test="#request.SelectCledit.tmhouseauditStatus==1">待审核</c:if>
						    ...
						    <td>
						    <c:if test="#request.SelectCledit.tmhouseauditStatus==3"><a href="queryselectindex.do?userId=${map.id}&TypeId=6">查看</a></c:if>
							...
							<!--  -->
							<td>购车</td>
							<td><c:if test="#request.SelectCledit.tmcarauditStatus==1">待审核</c:if>
						    ...
						    <td><c:if test="#request.SelectCledit.tmcarauditStatus==3"><a href="queryselectindex.do?userId=${map.id}&TypeId=7">查看</a></c:if>
							...
							<tr class="gvItem">
							<!--  -->
							<td>结婚</td><td><c:if test="#request.SelectCledit.tmmerrayauditStatus==1">待审核</c:if>
						 ...
						 ${SelectCledit.merraycriditing }
						    ...
						    <c:if test="#request.SelectCledit.tmmerrayauditStatus==3"><a href="queryselectindex.do?userId=${map.id}&TypeId=8">查看</a></c:if>
						...
						<tr class="gvItem">
							<!--  -->
							<td>学历</td><td><c:if test="#request.SelectCledit.tmxueliauditStatus==1">待审核</c:if>
						  ...
						  ${SelectCledit.xuelicriditing }
						    ...
						    <td>${SelectCledit.xuelioption}</td><td>${SelectCledit.xueliauthTime }</td><td>
						     <c:if test="#request.SelectCledit.tmxueliauditStatus==3"><a href="queryselectindex.do?userId=${map.id}&TypeId=9">查看</c:if>
							...
							<tr class="gvItem">
						    <!--  -->
							<td>技术</td><td><c:if test="#request.SelectCledit.tmjishuauditStatus==1">待审核</c:if>
						  ...
						  ${SelectCledit.jishucriditing }
						    ...
						    <td>${SelectCledit.jishuoption}</td><td>${SelectCledit.jishuauthTime }</td><td>
						       <c:if test="#request.SelectCledit.tmjishuauditStatus==3"><a href="queryselectindex.do?userId=${map.id}&TypeId=10">查看</a></c:if>
							...
							<tr class="gvItem">
							<!--  -->
							<td>手机</td><td><c:if test="#request.SelectCledit.tmtelephoneauditStatus==1">待审核</c:if>
					 ...
					 ${SelectCledit.telephonecriditing }
						    ...
						    <td>${SelectCledit.telephoneoption}</td><td>${SelectCledit.telephoneauthTime }</td><td>
						         <c:if test="#request.SelectCledit.tmtelephoneauditStatus==3"><a href="queryselectindex.do?userId=${map.id}&TypeId=11">查看</a></c:if>
							...
							<tr class="gvItem">
							<!--  -->
							<td>微博</td><td><c:if test="#request.SelectCledit.tmweiboauditStatus==1">待审核</c:if>
						    ...
						    <td>${SelectCledit.weibooption}</td><td>${SelectCledit.weiboauthTime }</td><td>
						         <c:if test="#request.SelectCledit.tmweiboauditStatus==3"><a href="queryselectindex.do?userId=${map.id}&TypeId=12">查看</a></c:if>
							...
							<!--  
							<tr>
							<td>视频</td><td><c:if test="#request.SelectCledit.tmshipingauditStatus==1">待审核</c:if>
						    ...
						    <td>${SelectCledit.shipingoption}</td><td>${SelectCledit.shipingauthTime }</td><td>
						      <c:if test="#request.SelectCledit.tmshipingauditStatus==1">  <a href="javascript:void(0)" style="cursor: pointer;" onclick="javascript:show();">审核</a></c:if>
							...
							<tr class="gvItem">
							<!--  -->
							<td>现场</td><td><c:if test="#request.SelectCledit.tmxcauditStatus==1">待审核</c:if>
						    ...
						    <td>${SelectCledit.xcoption}</td><td>${SelectCledit.xcauthTime }</td><td>
						             ...
						             <c:if test="#request.SelectCledit.tmxcauditStatus==3"><a href="queryselectindex.do?userId=${map.id}&TypeId=13">查看</a></c:if>
							...
							<tr class="gvItem">
							<!--  -->
							<td>抵押</td><td><c:if test="#request.SelectCledit.tmdiyaauditStatus==1">待审核</c:if>
						    ...
						    <td>${SelectCledit.diyaoption}</td><td>${SelectCledit.diyaauthTime }</td><td>
						             ...
						             <c:if test="#request.SelectCledit.tmdiyaauditStatus==3"><a href="queryselectindex.do?userId=${map.id}&TypeId=14">查看</a></c:if>
						   ...
						   <tr class="gvItem">
							<!--  -->
							<td>担保</td>
							<td><c:if test="#request.SelectCledit.tmdanbaoauditStatus==1">待审核</c:if>
						 ...
						 <!--  modify by houli 放错地方了    ${SelectCledit.danbaooption} -->
						    <td>${SelectCledit.danbaooption}</td><td>${SelectCledit.danbaoauthTime }</td><td>
						             <c:if test="#request.SelectCledit.tmdanbaoauditStatus==3"><a href="queryselectindex.do?userId=${map.id}&TypeId=15">查看</a></c:if>
						    ...
						    <tr class="gvItem">
							<!--  -->
							<td>其他</td><td><c:if test="#request.SelectCledit.tmqitaauditStatus==1">待审核</c:if>
						    ...
						    <td>${SelectCledit.qitaoption}</td><td>${SelectCledit.qitaauthTime }</td><td>
						             ...
						             <c:if test="#request.SelectCledit.tmqitaauditStatus==3"><a href="queryselectindex.do?userId=${map.id}&TypeId=16">查看</a></c:if>
