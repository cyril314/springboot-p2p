										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											...
											<tr>
												...
												<td align="right">
												  ...
												  <c:if test="#request.map.auditStatus==1">该项等待审核</c:if>
											...
											<tr>
												<td align="right">
												  <span style="color: red;">
												  <c:if test="#request.map.directedStatus==1">该项等待审核</c:if>
											...
											<tr>
												...
												<td align="right">
												    <span style="color: red;">
												  <c:if test="#request.map.otherStatus==1">该项等待审核</c:if>
											...
											<tr align="center">
												<td align="right">
												 <span style="color: red;" >
												  <c:if test="#request.map.moredStatus==1">该项等待审核</c:if>
