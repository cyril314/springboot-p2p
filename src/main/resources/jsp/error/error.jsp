...
<div class="error__container">
    ...
    <div class="error__title">抱歉，你的登录已经过期!!</div>
    <div class="error__description"> 点击以下链接继续浏览网站的其它内容!</div>
    <button class="action" onclick="javascript:window.history.go(-1);">返回</button>
    <button class="action" onclick="javascript:window.parent.close();">关闭页面</button>
</div>
<!-- 引用底部公共部分 -->
