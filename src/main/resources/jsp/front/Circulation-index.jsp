...
<div class="nymain" style="width:400px;margin-top:-10px;">
  ...
  <tr>
    <td>购买份数：</td>
    <td><a href="javascript:void(0);" onclick="cutimg()"><img src="{ctx}/static/images/cut.png" title="减1" /></a>
    <strong><input type="text" class="inp40" value="1" id="result" maxlength="20"/>
    <a href="javascript:void(0);" onclick="addimg(${borrowDetailMap.remainCirculationNumber})"><img src="{ctx}/static/images/add.png" title="加1" /></a>&nbsp;份</strong></td>
  </tr>
	<tr>
