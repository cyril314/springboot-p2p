...
<div  class="page" >
	     <shove:page url="borrowConcernList.do" curPage="${pageBean.pageNum}" showPageCount="10" pageSize="${pageBean.pageSize }" theme="jsNumber" totalCount="${pageBean.totalNum}">
...
function del(obj){
     ...
     var initCallBack;
     $.post("delBorrowConcern.do",param,initCallBack);
     confirm("确定删除?")
