...
<div class="box" >
  ...
  <tr>
	...
	<s:iterator value="pageBean.page" var="bean">
	 ...
	 <div  class="page" >
		     <shove:page url="queryBorrowInvestorInfo.do" curPage="${pageBean.pageNum}" showPageCount="10" pageSize="${pageBean.pageSize }" theme="jsNumber" totalCount="${pageBean.totalNum}">
...
function showAgree() {
	...
	jQuery.jBox.open("post:" + url, "查看协议书", 600, 400, {
		buttons : {}
	});
}
