...
<div class="account">
	...
	<div class="acc_content" style="margin-top:20px">
		...
		<!--账户详情 开始-->
		<div class="acc_all">
			<div class="cur"><img src="{ctx}/static/images/home.jpg" /> 当前位置：<a href="queryMySuccessBorrowInit.do">还款管理</a>  > 已还完的借款</div>
			<div id="acc_tabs">
				<div class="title">
					<a onclick="jumpUrl('queryMySuccessBorrowInit.do')">成功的借款</a>
					<a onclick="jumpUrl('queryMyPayingBorrowInit.do')">还款中的借款</a>
					<a class="on" onclick="jumpUrl('queryPayoffInit.do')">已还完的借款</a>
				</div>				
				<!--内容 开始-->
...
$(function(){
   ...
   function excel3()
	...
	function initListInfo(param){
		$.post("queryPayoffList.do",param,function(data){
