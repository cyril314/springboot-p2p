  ...
  <s:else>
    <s:iterator value="pageBean.page"  var="bean"> 
       <tr>
	    ...
	    <td align="center">
	    <c:if test="#bean.repayStatus==1"><a href="javascript:myPay(${bean.payId });">还款</a></c:if>
	        <s:else>---</s:else>
	    </td>
	  </tr>
    </s:iterator>
          ...
          <div  class="page" >
	     <shove:page url="queryAllDetails.do" curPage="${pageBean.pageNum}" showPageCount="10" pageSize="${pageBean.pageSize }" theme="jsNumber" totalCount="${pageBean.totalNum}">
