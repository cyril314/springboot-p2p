...
<div class="nymain" >
  <div class="ifbox1">
  <h2>确定竞拍 <img src="{ctx}/static/images/neiye2_06.jpg" width="4" height="7" /></h2>
  <div class="boxmain" style="padding-top:20px; padding-bottom:20px;">
    <div class="qrtbs">
      ...
      <div class="tbmains">
        ...
        <div class="tbczz">
          <p class="money">
         您的帐户总额：<strong>${paramMap.totalSum} 元 </strong> <a href="rechargeInit.do" class="czbtn"><img src="{ctx}/static/images/tubiao3.png" /></a><br/>
         ...
         拍卖底价：<strong>${paramMap.auctionBasePrice} 元 </strong>
          <br/>
         已出最高价：<c:if test="#request.paramMap.auctionMode==1"><strong>
         <c:if test="#request.paramMap.auctionHighPrice !=''">${paramMap.auctionHighPrice}</c:if><s:else>0</s:else>
          元
          </strong>
          </c:if>
