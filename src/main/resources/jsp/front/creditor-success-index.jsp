 ...
 <c:if test="pageBean.page==null || pageBean.page.size<=0">
  ...
  <tr>
    ...
    <shove:img src="${personalHead }" defaulImg="images/hslogo_42.jpg" width="80" height="79"></shove:img></a>
      &nbsp;<a href="userMeg.do?id=${publisher}" target="_blank">${borrowerName }</a>&nbsp; <img src="{ctx}/static/images/ico_${creditratingIco }.jpg" title="${creditrating }分" /></td>
    ...
    <s:else>无</s:else></td>
    <td align="center"><c:if test="#bean.auctionMode ==1">
    		明拍
    	</c:if>
    	<s:else>
    		暗拍
    ...
    <div  class="page" >
     <shove:page url="queryFrontSuccessDebt.do" curPage="${pageBean.pageNum}" showPageCount="10" pageSize="${pageBean.pageSize }" theme="jsNumber" totalCount="${pageBean.totalNum}">
