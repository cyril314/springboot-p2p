...
<div class="zqbanner">
<img src="{ctx}/static/images/neiye-zq_13.jpg" width="981" height="270" /></div>
<div class="zqmain">
  <div class="l-nav">
...
<li><a href="#">如何转让已有的债权？</a></li></ul>-->
  ...
  <ul><li  style="width: 340px;">
    <div class="pic">
      <img src="{ctx}/static/images/neiye-zq_19.jpg" width="87" height="108" />
      </div>
       <p>债权人在借款过程中遇到急用款的情况，通过债权转让更加<strong>及时的回收</strong>资金以备不时之需</p>
  </li><li style="width: 340px;">
    <div class="pic">
      <img src="{ctx}/static/images/neiye-zq_21.jpg" width="87" height="108" />
      </div>
        <p>债权人在借款过程中遇到逾期情况进行债权转让，最大程度的<strong>降低资金的损失度</strong></p>
  </li><li  style="width: 340px;">
    <div class="pic">
      <img src="{ctx}/static/images/neiye-zq_31.jpg" width="87" height="108" />
      </div>
