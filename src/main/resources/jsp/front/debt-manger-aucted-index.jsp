...
<jsp:include page="../include/top.jsp"></jsp:include>
	...
	<div class="acc_content" style="margin-top:20px">
		...
		<!--账户详情 开始-->
		<div class="acc_all">
			<div class="cur"><img src="{ctx}/static/images/home.jpg" /> 当前位置：<a href="queryCanAssignmentDebtInit.do">债权转让</a>  > 转让结束的债权</div>
			<div id="acc_tabs">
				<div class="title">
					<a onclick="goUrl('queryCanAssignmentDebtInit.do');">可转让的债权</a>
					<a onclick="goUrl('queryAuctingDebtInit.do');">转让中的债权</a>
					<a class="on" onclick="goUrl('queryAuctedDebtInit.do');">转让结束的债权</a>
					<a onclick="goUrl('queryAuctionFailDebtInit.do');">转让失败的债权</a>
				</div>				
				<!--内容 开始-->
				<div class="rz_content clearfix tab_content" id="showContent">
					<div align="center"><img src="{ctx}/static/images/load.gif"/></div>
				</div>
				<!--内容 结束-->
				<!--弹出层 开始-->
				<div id="pop_box"></div>
...
function initListInfo(param){
	$.post("queryAuctedDebt.do",param,function(data){
