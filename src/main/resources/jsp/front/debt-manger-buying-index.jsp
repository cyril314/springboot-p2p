...
<div class="account">
	...
	<div class="acc_content" style="margin-top:20px">
		...
		<!--账户详情 开始-->
		<div class="acc_all">
			<div class="cur"><img src="{ctx}/static/images/home.jpg" /> 当前位置：<a href="queryBuyingDebtInit.do">债权购买</a>  > 参与购买的债权</div>
			<div id="acc_tabs">
				<div class="title">
					<a class="on" onclick="goUrl('queryBuyingDebtInit.do')">参与购买的债权</a>
					<a onclick="goUrl('querySucessBuyedDebtInit.do')">已成功购买的债权</a>
				</div>				
				<!--内容 开始-->
...
<script>
	...
	function initListInfo(param){
		$.post("queryBuyingDebt.do",param,function(data){
