  ...
  <div class="center">
    <div class="inmes_all" id="in_money">
      <div class="inmes_top">
		...
		<a href="dliFinance.do" class="ca_back">返回</a>
      </div>
...
$(function(){
	 $('#btnsave').click(function(){
		 var param = {};
		 var webUser = '${user.userName}';
		 var duoli = '${duoli.user}';
		 if(webUser==''&&duoli==''){
			window.location.href="dliLogin.do";
		  }else{
		     ...
		     if(flag){
	           flag = false;
		       $.shovePost('dliFinanceInvest.do',param,function(data){
			      var callBack = data.msg;
