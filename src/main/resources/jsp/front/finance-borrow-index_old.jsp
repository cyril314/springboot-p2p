...
<dl class="tz_dl clearfix all_zq">
    <dt>
        ...
        <ul class="item" id="order">
            <li class="col1" style="text-align: center;"> 借款标题/借款类型</li>
            <li class="col2"> 信用等级</li>
            <li class="col3" style="align:center;">
                <a href="javascript:void(0);" style="cursor: pointer; font-size: 14px;padding-right:10px; display:block;width:75px;"
                   class="down" id="11">年利率</a>
            </li>
            <li class="col4" style="align:center;">
                <a href="javascript:void(0);" style="cursor: pointer; font-size: 14px; display:block;text-align:center;width:110px;"
                   class="down" id="13">网站奖励</a>
            </li>
            <li class="col5" style="align:center;">
                <a href="javascript:void(0);" style="cursor: pointer; font-size: 14px;padding-right:10px; display:block;width:75px;"
                   class="down" id="14">金额</a>
            </li>
            <li class="col6" style="align:center;">
                <a href="javascript:void(0);" style="cursor: pointer; font-size: 14px;padding-right:10px; display:block;width:75px;"
                   class="down" id="12">期限</a>
            </li>
            <li class="col7" style="align:center;">
                <a href="javascript:void(0);" style="cursor: pointer; font-size: 14px;padding-right:10px; display:block;width:75px;"
                   class="down" id="15">进度</a>
            </li>
            <li class="col8"> 操作</li>
        </ul>
    </dt>
...
<script type="text/javascript">
    ...
    function initListInfo(param) {
        ...
        $.post("financeBorrowList.do", param, function (data) {
            $("#showList").html(data);
        });
    };
</script>
