...
<div class="nymain">
  <div class="ifbox1">
  <h2><span><a href="javascript:void(0);" id="sendmail">发送站内信</a> <a href="javascript:void(0);" id="reportuser">举报此人</a></span>标的详情 <img src="{ctx}/static/images/neiye2_06.jpg" width="4" height="7" /></h2>
  <div class="boxmain">
    <div class="pic-info">
      <div class="tx">
...
<!-- Baidu Button END -->
  ...
  <tr>
   <td>
    ...
    还款方式： <c:if test="%{#request.borrowDetailMap.paymentMode == 1}">按月分期还款</c:if>
...
份&nbsp;&nbsp; </div></td>
 -->
    <td width="100%" align="center"><div style="width:98px; height: 40px">
   			 <c:if test="%{#request.borrowDetailMap.borrowStatus == 1}">
            <img src="{ctx}/static/images/neiye2_15.jpg" width="97" height="31"/>&nbsp;
      	  	</c:if>
      	  	 <s:elseif test="%{#request.borrowDetailMap.borrowStatus == 2}">
             <input type="image" src="{ctx}/static/images/gogo_rg.gif" value="" id="invest" onclick="mycirculationPay(${borrowDetailMap.id})" class="bttn_2"/>
	        </s:elseif>
	        <s:elseif test="%{#request.borrowDetailMap.borrowStatus == 3}">
	            <img src="{ctx}/static/images/neiye2_16.jpg" width="97" height="31"/>&nbsp;
	        </s:elseif>
	        <s:elseif test="%{#request.borrowDetailMap.borrowStatus == 4}">
	            <img src="{ctx}/static/images/neiye1_08.jpg" title="流转标回购中" width="98" height="32" />&nbsp;
	        </s:elseif>
	        <s:elseif test="%{#request.borrowDetailMap.borrowStatus == 5}">
	           <img src="{ctx}/static/images/neiye1_637.jpg" width="97" height="31"/>&nbsp;
      		  </s:elseif>
		        <s:else>
		           <img src="{ctx}/static/images/neiye2_18.jpg" width="97" height="31"/>&nbsp;
		        </s:else>
	</div></td>
  </tr>
  <tr>  
  ...
  <c:if test="%{#request.investList !=null && #request.investList.size()>0}">
    ...
    <c:if test="#investList.creditedStatus ==2"><img src="{ctx}/static/images/zrico.jpg" width="30" height="16"/></c:if>
    </a></td>
    <td align="center" class="fred">￥<c:out value="#investList.investAmount"/></td>
    <td align="center"><c:out value="#investList.investTime"/></td>
    </tr>
  </s:iterator>        
  </c:if>
  <s:else>
