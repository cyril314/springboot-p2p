...
<div class="box">
  ...
  <tr>
    ...
    <td align="center" id="allForPIOneMonth">￥<c:if test="#request.backAcountStatisMap.allForPIOneMonth !=''">${requestScope.backAcountStatisMap.allForPIOneMonth}</c:if><s:else>0</s:else></td>
    <td align="center" id="allForPIThreeMonth">￥<c:if test="#request.backAcountStatisMap.allForPIThreeMonth !=''">${backAcountStatisMap.allForPIThreeMonth}</c:if><s:else>0</s:else></td>
    <td align="center" id="allForPIYear">￥<c:if test="#request.backAcountStatisMap.allForPIYear !=''">${backAcountStatisMap.allForPIYear}</c:if><s:else>0</s:else></td>
    <td align="center" id="allForPI">￥<c:if test="#request.backAcountStatisMap.allForPI !=''">${backAcountStatisMap.allForPI}</c:if><s:else>0</s:else></td>
    </tr>
          </table>
          <p>&nbsp;</p>
          </div>
...
<div  class="page" >
	     <shove:page url="homeBorrowBackAcountList.do" curPage="${pageBean.pageNum}" showPageCount="10" pageSize="${pageBean.pageSize }" theme="jsNumber" totalCount="${pageBean.totalNum}">
