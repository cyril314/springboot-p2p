...
<div class="account">
	...
	<div class="acc_content" style="margin-top:20px">
		...
		<!--账户详情 开始-->
		<div class="acc_all">
			<div class="cur"><img src="{ctx}/static/images/home.jpg" /> 当前位置：<a href="homeBorrowInvestInit.do">投资管理</a>  > 回款中的投标</div>
			<div id="acc_tabs">
				<div class="title">
					<a onclick="jumpUrl('homeBorrowInvestInit.do');">投资记录</a>
					<a class="on" onclick="jumpUrl('homeBorrowRecycleInit.do');">回款中的投标</a>
...
function initListInfo(param){
	$.post("homeBorrowRecycleList.do",param,function(data){
