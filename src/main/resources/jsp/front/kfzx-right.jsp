...
<div class="box">
      <h2><c:out value="#request.curDes" default="新手入门" ></s:property>aa</h2>
      <div class="boxmain">
      <ul>
    ...
    <div class="page">
	<p>
	   	<shove:page url="callcenter.do" curPage="${pageBean.pageNum}" showPageCount="4" pageSize="${pageBean.pageSize }" theme="jsNumber" totalCount="${pageBean.totalNum}">
