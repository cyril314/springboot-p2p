						...
						<div class="biaoge2" style="margin-top: 0px;">
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tr>
									...
									<td class="txt">
										<strong>注：尊敬的用户，您在好乐易贷网的相关操作， 好乐易贷网会用以上三种方式<br />通知您，请您选择适合自己的通知方式！
						...
						<div class="biaoge2" style="margin-top: 0px;">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<td width="83%">
										<span class="txt" id="cardUserName1"> <c:out
						...
						<div class="biaoge2">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<td width="83%">
										<span class="txt" id="cardUserName2"> <c:out
												value="#request.realName" default="---"></s:property>
										</span>
										<br />
									</td>
...
<!-- 基本信息，工作认证js-->
<script type="text/javascript" src="${ctx}/static/js/user_check.js"></script>
<script type="text/javascript" src="${ctx}/static/script/user_work.js"></script>
<!-- 页面JS方法 -->
<script>
   /* $(function(){
