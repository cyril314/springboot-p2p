...
<div class="nymain">
      ...
      <div class="tabtil">
        <ul>
						...
						<%-- 	<li onclick="loadWorkInit('queryWorkInit.do');">
							...
							--%>
							<li   class="on" onclick="jumpUrl('updatexgmm.do');">
								修改密码
							</li>
  ...
  <tr>
    <th colspan="2" align="left" style="padding-top:0px;"> 会员登录密码修改</th>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <th colspan="2" align="left" style="padding-top:0px;"> 会员交易密码修改</th>
    </tr>
  <tr>
    <td width="18%" align="right">原密码：</td>
    <td width="83%"><input type="password" class="inp188" id="oldDealpwd" />
      <span class="txt">输入您现在的交易密码，初始交易密码为账号密码</span></td>
  </tr>
  <tr>
    <td align="right">新密码：</td>
  ...
  <tr>
    <td align="right">&nbsp;</td>
    <td style="padding-top:10px;"><a href="javascript:void(0);" class="bcbtn" onclick="javascript:updateDealPassword();">提交</a>
