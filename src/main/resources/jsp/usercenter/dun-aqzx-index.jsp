...
<div class="ny_main1 clearfix">
	<div class="myhome_main clearfix">
        ...
        <div class="myhome_r clearfix">
        	<!--标题 开始-->
		    <div class="ny_tit"><ul><li class="on">安全中心</li></ul></div>
            <!--标题 结束-->
            <!--内容 开始-->	
            	...
            	<ul class="security-ul m-t25 clearfix">
                    <li>
                        <div class="clearfix">
                            ...
                            <div class="update"><a href="changePwdInit.do">修改</a></div>
                        </div>
                    </li>
                    <li>
                        <div class="clearfix">
                            ...
                            <h4>交易密码</h4>
                            <p>在账户资金变动时需要输入的密码</p>
                            <div class="update"><a href="changeDealpwdInit.do">修改</a></div>
                        </div>
                    </li>
                    <li>
                        <div class="clearfix">
                            ...
                            <div class="update">
                            	<c:if test="#request.mobilePhone!=null">
                            		<a href="reBindingMobileInit.do">更换</a>
                            	</c:if>
                            	<s:else>
                            		<a href="bindingMobileInit.do">绑定</a>
                            	</s:else>
                            </div>
                        </div>
                    </li>
