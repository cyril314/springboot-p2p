            ...
            <div class="rz_content clearfix">
                ...
                <div class="tips clearfix">
                    <dl class="h_srch clearfix">
                        <dt>起止日期：</dt>
                        <dd><input id="startTime" type="text" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:'readOnly'})"
                                   class="test"/> - <input id="endTime" type="text"
                                                           onclick="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:'readOnly'})" class="test"/>
                        </dd>
                        <dd></dd>
                        <dd></dd>
                        <dt>交易类型：</dt>
                        <dd><s:select list="potypeList" id="momeyType" name="momeyType" listKey="operateType" listValue="fundMode"
                                      cssStyle="width:180px;" headerKey="" headerValue="--请选择--" cssClass="sel"></s:select></dd>
                        <dd></dd>
                ...
                <%--<p style="text-align:right; padding:5px 0;"><em class="execl">导出excel</em></p>
                 --%>
                <div class="biaoge" id="fundRecord"></div>
            </div>
            <!--内容 结束-->
        </div>
        <!--右 结束-->
