        ...
        <div class="myhome_r clearfix">
		    ...
		    <div class="ny_tit">
            	<ul>
                	...
                	<li id="reAcquisition" onclick="javascript:jumpUrl('dunReAcquisitionInit.do')">回款中的收购</li>
                	<li id="acquisitioned" onclick="javascript:jumpUrl('dunAcquisitionedInit.do')" class="on">已回款的收购</li>
                </ul>
            </div>
            <!--标题 结束-->
            <!--内容 开始-->	
...
<script>
    $(function(){
	 ...
	 function initListInfo(praData){
		$.shovePost("dunAcquisitionedList.do",praData,initCallBack);
	}
