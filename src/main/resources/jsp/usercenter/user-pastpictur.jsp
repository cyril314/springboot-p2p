			...
			<div class="r-main" style="border:none; float:none; width:auto;">
				<div class="rmainbox" style="padding-left:0px; padding-right:0px; padding:0px;">
					<div class="tcbox" style="display:-none; position:static; margin:0px auto; padding:0px;">
						<div class="tcmain">
      						<c:if test="#request.typmap.materAuthTypeId==6">
								<h3>房产认证：</h3>
								<p>房产证明是证明借入者资产及还款能力的重要凭证,好乐易贷会根据借款者提供的房产证明给与借入者一定的信用加分。</p>
								...
								<p>2、 请确认您上传的资料是清晰的、未经修改的照片，每张照片最大限制为1M</p>
							</c:if>
 
      						<c:if test="#request.typmap.materAuthTypeId==1">
            					<h3>身份认证：</h3>
      						...
      						<c:if test="#request.typmap.materAuthTypeId==2">
            					<h3>工作认证：</h3>
      							<p>您的工作状况是好乐易贷评估您信用状况的主要依据。请您填写真实可靠的工作信息。 </p>
      							<p><strong>认证说明：</strong><br />
									1、工薪阶层（入职须6个月以上）：<br>
      						...
      						<c:if test="#request.typmap.materAuthTypeId==3">
            					<h3>居住地认证：</h3>
								<p>居住地的稳定性，是好乐易贷考核借款人的主要评估因素之一，通过好乐易贷居住地证明，您将获得一定的信用加分。 </p>
								<p><strong>认证说明：</strong><br />
      						...
      						<c:if test="#request.typmap.materAuthTypeId==4">
            					<h3>央行信用认证：</h3>
      							<p>个人信用报告是由中国人民银行出具，全面记录个人信用活动，反映个人信用基本状况的文件。本报告是好乐易贷了解您信用状况的一个重要参考资料。 您信用报告内体现的信用记录，和信用卡额度等数据，将在您发布借款时经好乐易贷工作人员整理，在充分保护您隐私的前提下披露给好乐易贷借出者，作为借出者投标的依据。</p>
      							<p><strong>认证说明：</strong><br />
      						...
      						<c:if test="#request.typmap.materAuthTypeId==5">
            					<h3>收入认证：</h3>
      							<p>您的银行流水单以及完税证明，是证明您收入情况的主要文件，也是好乐易贷评估您还款能力的主要依据之一。 </p>
      							<p><strong>认证说明：</strong><br />
									1、工薪阶层（入职须6个月以上）：<br />
									请上传以下一项或者多项资料的照片<br />
      						...
      						<c:if test="#request.typmap.materAuthTypeId==7">
            					<h3>车辆认证：</h3>
      							<p>购车证明是证明借入者资产及还款能力的重要凭证之一，好乐易贷会根据借入者提供的购车证明给与借入者一定的信用加分。</p>
      							<p><strong>认证说明：</strong><br />
									1、请您上传购买车辆的车辆登记证、行驶证原件照片；<br />
									2、请您上传购买车辆的发票或者银行按揭合同；<br />
									3、 请确认您上传的资料是清晰的、未经修改的照片，每张照片最大限制为1M<br />
								</p>
							</c:if>
 
      						<c:if test="#request.typmap.materAuthTypeId==8">
            					<h3>结婚认证：</h3>
      							<p>借入者的婚姻状况的稳定性，是好乐易贷考核借款人信用的评估因素之一，通过好乐易贷结婚认证，您将获得一定的信用加分。</p>
      							<p><strong>认证说明：</strong><br />
									1、请您上传以下资料<br />
										a）您本人结婚证原件照片<br />
										b）您配偶正面、反面第二代身份证原件照片<br />
										c）您和配偶的近照合影一张<br />
								</p>
								<p>2、 请确认您上传的资料是清晰的、未经修改的照片，每张照片最大限制为1M</p>
							</c:if>
 
      						<c:if test="#request.typmap.materAuthTypeId==9">
            					<h3>学历认证：</h3>
      							<p>借出者在选择借款列表投标时，借入者的学历也是一个重要的参考因素。为了让借出者更好、更快地相信您的学历是真实的，强烈建议您对学历进行在线验证。</p>
      							<p><strong>认证说明：</strong><br />
									1、您上传的资料须是学信网您个人学历信息截图；<br />
								</p>
								<p>2、 请确认您上传的资料是清晰的、未经修改的照片，每张照片最大限制为1M</p>
							</c:if>
 
      						<c:if test="#request.typmap.materAuthTypeId==10">
            					<h3>技术职称认证：</h3>
      							<p>技术职称是经专家评审、反映一个人专业技术水平并作为聘任专业技术职务依据的一种资格，不与工资挂钩，是好乐易贷考核借款人信用的评估因素之一，通过好乐易贷技术职称认证证明，您将获得一定的信用加分。</p>
      							<p><strong>认证说明：</strong><br />
									1、请上传技术职称证书（国家承认的二级及以上等级证书，如会计证、律师证、工程证书等）；<br />
								</p>
								<p>2、 请确认您上传的资料是清晰的、未经修改的照片，每张照片最大限制为1M</p>
							</c:if>
							
							<c:if test="#request.typmap.materAuthTypeId==11">
								<h3>手机认证：</h3>
								<p>手机流水单是最近一段时间内的详细通话记录，是好乐易贷用以验证借入者真实性的重要凭证之一。您的手机详单不会以任何形式被泄露。</p>
								<p><strong>认证说明：</strong><br />
									1、请您上传您最近6个月的手机通话记录清单，用户姓名与号码须显示在同一界面；<br />
								</p>
								<p>2、 请确认您上传的资料是清晰的、未经修改的照片，每张照片最大限制为1M</p>
							</c:if>
							
							<c:if test="#request.typmap.materAuthTypeId==12">
								<h3>微博认证：</h3>
								<p><strong>认证说明：</strong><br /><br />
									1、 请确认您上传的资料是清晰的、未经修改的照片，每张照片最大限制为1M</p>
							</c:if>

      						<c:if test="#request.typmap.materAuthTypeId==13">
      							<h3>现场认证：</h3><br/>
      							<p> 请上传盖有好乐易贷公章的现场认证书</p>
      							<p><strong>认证说明：</strong><br />
      						...
      						<c:if test="#request.typmap.materAuthTypeId==14">
      							<h3>抵押认证：</h3>
      							<p><strong>认证说明：</strong><br /><br />
      						...
      						<c:if test="#request.typmap.materAuthTypeId==15">
      							<h3>担保认证：</h3>
      							<p><strong>认证说明：</strong><br /><br />
      								1、 请确认您上传的资料是清晰的、未经修改的照片，每张照片最大限制为1M
      							</p>
      						...
      						<c:if test="#request.typmap.materAuthTypeId==16">
      							<h3>其他资料：</h3>
      							<!--     <p><strong>认证说明：</strong><br /> -->
      							<p>
      					...
      					<div class="ysctab">
      						<table width="100%" border="0" cellspacing="0" cellpadding="0" id="sssd">
								<tr id="fg">
				  				...
				  				<c:if test="#request.userPicDate==null || request.userPicDate.size == 0 ">
								...
								<s:else>
									...
									<tr id='s_${st.count }'>
									 <!--  
									  ...
									  -->
										<td align="center"><input type="checkbox" name="items" id="${st.count }" value="${id}"     <c:if test="#bean.visiable==1">checked="checked"</c:if> /></td>
										...
										<td align="center">
											...
											<c:if test="#bean.auditStatus==2">失败</c:if>
											<c:if test="#bean.auditStatus==3">通过</c:if>
										</td>
										<td align="center">-</td>
									</tr>
									</s:iterator>
    							...
    							<tr id="ggggs">
    								<td colspan="5" style="border:none; padding-top:10px;">
    									<a style="padding-left:6.5%"><input type="checkbox" name="checkbox4" id="select"  /> 全选 </a>
   						...
   						<div class="xzzl">
   								...
   								<table width="100%" border="0" cellspacing="0" cellpadding="0">
   									<tr id="mytable">
   										...
   										<td align="left">
   											...
   											<input type="button" class="bcbtn" value="上传" id="shanc" onclick="updateFiledatefirest(this)" >
   										</td>
   									</tr>
									  <!--  
									  <tr id="mytable">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr style="width: 100%">
									<td valign="top"><img src="{ctx}/static/images/warning.png" ></td>
									<td  style="color: red;font-size: 12px" >好乐易贷是一个注重诚信的网络平台。如果我们发现您上传的资料系伪造或有人工修改痕迹，好乐易贷会将你加入系统黑名单，永久取消您在好乐易贷的借款资格。</td>
								</tr>
							</table>
						</div>
					</div>
